...
QStringList MaxPower::GetYAxisParameters(ExperimentType type) const {
	QStringList ret;
...
void MaxPower::SaveDcDataHeader(QFile &saveFile, const ExperimentNotes &notes) const {
...
void MaxPower::SaveDcData(QFile &saveFile, const DataMap &container) const {
	SAVE_DATA_START();
